...
%% Sampling
frame1 = zt_inphase_timing(starts(1): starts(2)-upsampling_rate*(length(frame_sync)+1)).* exp(-j*phases(1));
frame2 = zt_inphase_timing(starts(2): starts(3)-upsampling_rate*(length(frame_sync)+1)).* exp(-j*phases(2));
frame3 = zt_inphase_timing(starts(3): starts(4)-upsampling_rate*(length(frame_sync)+1)).* exp(-j*phases(3));
frame4 = zt_inphase_timing(starts(4): starts(5)-upsampling_rate*(length(frame_sync)+1)).* exp(-j*phases(4));
frame5 = zt_inphase_timing(starts(5): starts(6)-upsampling_rate*(length(frame_sync)+1)).* exp(-j*phases(5));
frame6 = zt_inphase_timing(starts(6): starts(7)-upsampling_rate*(length(frame_sync)+1)).* exp(-j*phases(6));
frame7 = zt_inphase_timing(starts(7): starts(8)-upsampling_rate*(length(frame_sync)+1)).* exp(-j*phases(7));
frame8 = zt_inphase_timing(starts(8): starts(9)-upsampling_rate*(length(frame_sync)+1)).* exp(-j*phases(8));
frame9 = zt_inphase_timing(starts(9): starts(10)-upsampling_rate*(length(frame_sync)+1)).* exp(-j*phases(9));
frame10 = zt_inphase_timing(starts(10): end-1-upsampling_rate*(length(frame_sync)+1)).* exp(-j*phases(10));
...
zk10 = frame10(1:upsampling_rate:length(frame9));
